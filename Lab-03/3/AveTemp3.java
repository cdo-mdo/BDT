...
public class AveTemp3 extends Configured implements Tool {

	public static void main(String[] args) throws Exception {
		if (args.length != 2) {
		    System.err.println("Usage: AveTemp3 <input path> <output path>");
		    System.exit(-1);
		}
		...
		int res = ToolRunner.run(conf, new AveTemp3(), args);
		System.exit(res);
	}

	@Override
	public int run(String[] args) throws Exception {
		Job job = Job.getInstance(getConf(), "Average Temperature 3");
		job.setJarByClass(AveTemp3.class);
